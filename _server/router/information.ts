...
information.use("/user", rateLimiter(RateLimiterOption._1m_200req));
information.get("/user", users);
information.use("/user/posted", rateLimiter(RateLimiterOption._1m_200req));
information.get("/user/posted", postUsers);
information.use("/user/sig", rateLimiter(RateLimiterOption._1m_200req));
information.get("/user/sig", usersOfEachSigs);

information.use("/post", rateLimiter(RateLimiterOption._1m_200req));
information.get("/post", posts);
information.use("/post/sig", rateLimiter(RateLimiterOption._1m_200req));
information.get("/post/sig", postsOfEachSigs);

information.use("/like", rateLimiter(RateLimiterOption._1m_200req));
